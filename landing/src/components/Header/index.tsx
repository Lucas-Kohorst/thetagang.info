      ...
      <HeaderAbsoluteContainer>
        <LinksContainer>
          <ItemWithDropdown
            variant="desktop"
            dropdownItems={[
              { text: "Dashboard", link: "https://metrics.thetagang.info" },
              { text: "Dune", link: "https://duneanalytics.com/ribbon/Ribbon-Theta" },
            ]}
          >
            Metrics
          </ItemWithDropdown>
          <ItemWithDropdown
            variant="desktop"
            dropdownItems={[
              { text: "$RHAT DAO", link: "https://rhat.thetagang.info" },
              { text: "$RHAT EXPLORER", link: "https://explorer.thetagang.info" },
            ]}
          >
            $RHAT
          </ItemWithDropdown>
